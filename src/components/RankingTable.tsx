                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            {t.is_survivor && (
                              <span className="px-1.5 py-[1px] rounded text-[9px] font-mono font-black uppercase tracking-wider bg-amber-500/10 text-amber-300 border border-amber-500/30 shadow-[0_0_8px_rgba(245,158,11,0.08)]">
                                Sobrevivente do Esperneio
                              </span>
                            )}
                          </div>
